...
(function() {
  ...
  goog.require('gn_search_canada_config');
  goog.require('gn_search_canada_directive');

  var module = angular.module('gn_search_canada',
      ['gn_search', 'gn_search_canada_config',
       'gn_search_canada_directive', 'gn_related_directive',
